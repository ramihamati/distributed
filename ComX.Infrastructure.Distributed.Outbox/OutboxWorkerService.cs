...
namespace ComX.Infrastructure.Distributed.Outbox
{
    public class OutboxWorkerService : IOutboxWorkerService
    {
        ...
        public async Task PublishAsync(IntegrationMessageLog message, CancellationToken cancellationToken = default)
        {
            ...
            if (messageInfo is null)
            {
                throw new Exception($"Could not find an entry of the message with id {message.Id} in the store");
            }
