======================================================
Publisher MassTransit Mediator
======================================================
...
This publisher will use the `IMediator` to publish the messages. You have to configure mass transit because
the outbox worker will only use the `IMediator` service
...
.. code-block:: cs
   ...
   public void ConfigureServices(IServiceCollection services)
   {
      ...
      services.AddOutboxWorker<ConfigurationOutboxWorker>(cfg =>
      {
            ...
            {
               pubCfg.UseMassTransitMediatorPublisher();
            });
