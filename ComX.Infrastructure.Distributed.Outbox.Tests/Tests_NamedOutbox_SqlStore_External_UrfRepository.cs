...
namespace ComX.Infrastructure.Distributed.Outbox.Tests
{
     ...
     */
    public class Tests_NamedOutbox_SqlStore_External_UrfRepository
    {
        public SqliteConnection DbConnection { get; set; }

        public ServiceProvider ServiceProvider { get; set; }
        public IOutboxServiceContainer OutboxContainer { get; set; }
        public IOutboxService OutboxService { get; set; }
        ...
        public const string OUTBOX_NAME = "Name";
        ...
        public async Task OutboxService_Publish_ShouldSaveToDb_WithStatusPending()
        {
            ...
            IEventSerializer eventSerializer
              = OutboxContainer.ServiceProvider.GetService<IEventSerializer>();
            IUnitOfWork externalUOW
               = ServiceProvider.GetService<IUnitOfWork>();
